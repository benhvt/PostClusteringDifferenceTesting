...
#-p=10, 0.7 correlation, 0 clusters, ndraws = 2000 
...
filename_SI_2cl  <- "results/nb_var/p=10/selective_inference_2cl_delta=0_prop_var_cor=1"
filename_SI_4cl  <- "results/nb_var/p=10/selective_inference_4cl_delta=0_prop_var_cor=1"
filename_multimod <- "results/nb_var/p=10/multimod_delta=0_prop_var_cor=1"
filename_merge_4cl <- "results/nb_var/p=10/merge_selective_inference_4cl_delta=0_prop_var_cor=1"
filename_ttest <- "results/nb_var/p=10/ttest_4cl_delta=0_prop_var_cor=1"
...
for (i in 1:nsimu){
  ...
  diag(sigma) <- 1
  X <- rbind(rmvnorm(n=n/2, mean = rep(0, p), sigma = sigma),
             rmvnorm(n=n/2, mean = rep(delta,p, sigma = sigma)))
