...
filename_SI_2cl  <- "results/nb_var/p=4/selective_inference_2cl_delta=5_prop_var_cor=0"
filename_SI_4cl  <- "results/nb_var/p=4/selective_inference_4cl_delta=5_prop_var_cor=0"
filename_multimod <- "results/nb_var/p=4/multimod_delta=5_prop_var_cor=0"
filename_merge_4cl <- "results/nb_var/p=4/merge_selective_inference_4cl_delta=5_prop_var_cor=0"
filename_ttest <- "results/nb_var/p=4/ttest_4cl_delta=5_prop_var_cor=0"
